...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mdv3-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14223&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mdv3-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mdv3` can be installed with:

```
conda install mdv3
```

It is possible to list all of the versions of `mdv3` available on your platform with:
